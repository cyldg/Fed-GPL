...
# from domainbed.VIsionTransformer import VisionTransformer, PatchEmbed
...
def build_promptmodel(num_classes=10, edge_size=224, patch_size=16,
    ...
    try:
        ...
        # print('test model output：', softmax(preds,axis = 1))
    ...
    # img = torch.randn(1, 3, edge_size, edge_size)
    # preds = model(img)  # (1, class_number)
    # print('test model output：', softmax(preds.detach().numpy(),axis = 1))
